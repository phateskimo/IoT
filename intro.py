...
greeting = 'Hi '
name = 'Chris'  # enter your name in this string
...
age =  42 # enter your age here (as a number)
...
age = '42'  # enter your age here, as a string
...
my_team = ['Robert','Chris','Jody']
my_class.extend(my_team)
x=1
